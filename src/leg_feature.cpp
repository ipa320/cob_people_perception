...
LegFeature::LegFeature(tf::Stamped<tf::Point> loc, tf::TransformListener& tfl)
  : tfl_(tfl),
    leg_feature_predict_pos_cov_(0.8), //0.4 Around 0.05 // Variance of the
    leg_feature_predict_vel_cov_(2.4),  //1.8 Around 1.0 should be fine, the bigger the more spread
