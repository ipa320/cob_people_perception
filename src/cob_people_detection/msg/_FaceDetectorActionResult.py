...
class FaceDetectorActionResult(roslib.message.Message):
  ...
  _type = "cob_people_detection/FaceDetectorActionResult"
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','cob_people_detection/FaceDetectorResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = cob_people_detection.msg.FaceDetectorResult()
    else:
      self.header = std_msgs.msg._Header.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cob_people_detection.msg.FaceDetectorResult()
