...
class FaceNormalizer{
  ...
  public:
    ...
    void transformAffine(cv::Vec3f& eye_l,cv::Vec3f& eye_r,cv::Vec3f& nose,cv::Mat& trafo);
    void showImg(cv::Mat& img,std::string window_name);
    bool checkPlausibility(cv::Vec3f& eye_l,cv::Vec3f& eye_r,cv::Vec3f& nose,cv::Vec3f& mouth);
